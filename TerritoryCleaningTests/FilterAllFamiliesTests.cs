...
{
    [TestClass()]
    public class FilterAllFamiliesTests
    {
        [DataTestMethod()]
        [DataRow(1, 3)]
        [DataRow(2, 3)]
        [DataRow(3, 3)]
        [DataRow(100.99,0)]
        public void FilterAllFamiliesFirst_CheckIfCountIsRight_True(double amount, int count)
        {
            List<List<Family>> allFamilies = new List<List<Family>>();

            List<Family> families = new List<Family>();
            Family first = new Family("Maple Road", "Gonzalez", 2, 2, 4.5);
            Family second = new Family("Pine Street", "Wilson", 1, 1, 2.5);
            ...
            Cost cost1 = new Cost(2, 2, 4.5);
            Cost cost2 = new Cost(1, 1, 2.5);
            ...
            List<Family> filtered = taskUtils.FilterAllFamilies(amount, costs);
            Assert.AreEqual(count, filtered.Count());
        }
        [TestMethod()]
        public void FilterAllFamiliesSecond_CheckIfCountIsRight_True()
        {
            List<List<Family>> allFamilies = new List<List<Family>>();
            ...
            List<Family> filtered = taskUtils.FilterAllFamilies(costs);
